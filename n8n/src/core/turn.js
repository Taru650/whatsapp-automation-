...
function finalizeTurn(decision, result) {
  ...
  return {
    send: { to: env.wa_id, wa_hash: env.wa_hash, lang: env.lang, service_key: serviceKey, messages },
      ...
      resolved: log.resolved != null ? !!log.resolved : !decision.unanswered_reason,
      llm_tokens: decision.llm_tokens || null,
      ...
      unanswered_reason: decision.unanswered_reason || null,
